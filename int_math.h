...
public:
    ...
    static std::int32_t get_angle_to_point(const Coords<std::int32_t>& point_a,const Coords<std::int32_t>& point_b);
    ...
    static std::uint64_t get_distance_between_points(const Coords<std::int32_t>& point_a,const Coords<std::int32_t>& point_b);
    static std::uint64_t get_distance_between_points_no_sqrt(const Coords<std::int32_t>& point_a,const Coords<std::int32_t>& point_b);
};
