...
bool Button_Events::handle_button_event(string button_event,Window* parent_window){
    ...
    if(button_event.length()>0){
        if(button_event=="close_window"){
            ...
            window->set_stated_button_state_index(0,Strings::string_to_bool(Options::get_option_value("cl_screen_shake")));
            ...
            window->set_stated_button_state_index(0,Strings::string_to_bool(Options::get_option_value("cl_fullscreen_state")));
            ...
            window->set_stated_button_state_index(4,Strings::string_to_bool(Options::get_option_value("cl_hw_cursor")));
            window->set_stated_button_tooltip(4,Options::get_option_description("cl_hw_cursor"));

            window->set_stated_button_state_index(5,Strings::string_to_bool(Options::get_option_value("cl_font_shadows")));
            ...
            if(parent_window!=0){
                Options::apply_options_graphics(parent_window->get_info_text(0),parent_window->get_info_text(1),parent_window->get_info_text(2),
                                                        Strings::bool_to_string(Strings::string_to_bool(parent_window->get_stated_button_state(0))),
            ...
            window->set_stated_button_state_index(1,Strings::string_to_bool(Options::get_option_value("cl_mute_global")));
            ...
            window->set_stated_button_state_index(3,Strings::string_to_bool(Options::get_option_value("cl_mute_sound")));
            ...
            window->set_stated_button_state_index(0,Strings::string_to_bool(Options::get_option_value("cl_bind_cursor")));
            window->set_stated_button_tooltip(0,Options::get_option_description("cl_bind_cursor"));

            window->set_stated_button_state_index(1,Strings::string_to_bool(Options::get_option_value("cl_screen_keyboard")));
            window->set_stated_button_tooltip(1,Options::get_option_description("cl_screen_keyboard"));

            window->set_stated_button_state_index(2,Strings::string_to_bool(Options::get_option_value("cl_accelerometer_controller")));
            window->set_stated_button_tooltip(2,Options::get_option_description("cl_accelerometer_controller"));

            window->set_stated_button_state_index(3,Strings::string_to_bool(Options::get_option_value("cl_touch_controller_state")));
            ...
            if(parent_window!=0){
                Options::apply_options_input(Strings::bool_to_string(Strings::string_to_bool(parent_window->get_stated_button_state(0))),
                                                     Strings::bool_to_string(Strings::string_to_bool(parent_window->get_stated_button_state(1))),
            ...
            window->set_stated_button_state_index(0,Strings::string_to_bool(Options::get_option_value("cl_chat_timestamps")));
            ...
            if(parent_window!=0){
                ...
                Network_Client::add_server(parent_window->get_info_text(0),parent_window->get_info_text(1),Strings::string_to_unsigned_long(parent_window->get_info_text(2)),&password,password_required,0,0,"",0);
            ...
            if(parent_window!=0){
                Network_Client::edit_server(Engine::editing_server,parent_window->get_info_text(0),parent_window->get_info_text(1),Strings::string_to_unsigned_long(parent_window->get_info_text(2)),parent_window->get_info_text(3));
            ...
            if(server!=0){
                bool server_added=Network_Client::add_server(server->name,server->address,server->port,0,server->password_required,server->slots_filled,server->slots_total,server->version,server->ping);
