...
public:
    ...
    bool check_button_state(SDL_Renderer* renderer,SDL_GameControllerButton button);
    std::vector<SDL_GameControllerButton> check_for_button_press(SDL_Renderer* renderer,float x,float y);
