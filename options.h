...
class Options {
    public:
        ...
        static void apply_options(const std::string& cl_effect_limit, const std::string& cl_screen_shake,
                                  const std::string& cl_rumble);
        static void apply_options_graphics(const std::string& cl_screen_width, const std::string& cl_screen_height,
                                           const std::string& cl_display_number, const std::string& cl_fullscreen_state,
                                           const std::string& cl_fullscreen_mode, const std::string& cl_vsync,
                                           const std::string& cl_fps, const std::string& cl_hw_cursor,
        ...
        static void apply_options_input(const std::string& cl_bind_cursor, const std::string& cl_screen_keyboard,
                                        const std::string& cl_accelerometer_controller,
                                        const std::string& cl_touch_controller_state,
                                        const std::string& cl_touch_controller_opacity);
