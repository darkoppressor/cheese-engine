...
class Bitmap_Font {
    ...
    public:
        ...
        void show(double x, double y, std::string text, std::string font_color, double opacity = 1.0,
                  double scale_x = 1.0, double scale_y = 1.0, double angle = 0.0,
                  const SDL_Rect& allowed_area = FONT_DEFAULT_ALLOWED_AREA,
                  const std::vector<std::string>& character_colors = std::vector<std::string>());
        void show(double x, double y, std::string text, Color* font_color, double opacity = 1.0, double scale_x = 1.0,
                  double scale_y = 1.0, double angle = 0.0, const SDL_Rect& allowed_area = FONT_DEFAULT_ALLOWED_AREA,
                  const std::vector<std::string>& character_colors = std::vector<std::string>());
};
