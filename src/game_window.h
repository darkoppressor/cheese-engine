...
class Game_Window {
    private:
        ...
        static bool set_position(int* desired_resolution_x, int* desired_resolution_y, int* position_x,
                                 int* position_y);
        static void reload();
    ...
    public:
        ...
        static void render_copy_ex(SDL_Texture* texture, const SDL_Rect* srcrect, const SDL_Rect* dstrect,
